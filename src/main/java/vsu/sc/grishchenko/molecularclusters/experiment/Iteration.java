...
/**
 * <p>Класс, описывающий итерацию иеё параметры рамках задания
 * на выполнение рассчета серии экспериментов.</p>
 *
...
public class Iteration<T> {
    ...
    private double step;
    /**
     * <p>Текущее значение в процессе выпонения итерации.</p>
     */
    private double currentValue;
    /**
     * <p>Действие, которое необходимо выполнить с объектом, для которого проводится итерация
     * и текущим значение процессе итерации.</p>
     */
     ...
     *
     * @param obj объект, с которым необъодимо выполнить действие
    ...
    /**
     * <p>Возвращает итерацию в исходное положения.</p>
     */
    public void restart() {
        currentValue = from;
    }
