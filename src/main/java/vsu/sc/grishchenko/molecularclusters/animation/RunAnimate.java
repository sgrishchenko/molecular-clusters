...
/**
 * <p>Класс для управления воспроизведением анимации
...
public class RunAnimate implements Runnable {
     ...
     * Значения - списки точек трехмерного пространства, в которых положения частицы
    ...
    /**
     * <p>Флаг, при установке которого в состояние <code>true</code> воспроизведение приостанавливается,
     * а при установке в состояние <code>false</code> воспроизведение возобновляется.</p>
     */
    private boolean isPaused = false;
    /**
     * <p>Флаг, при установке которого в состояние <code>true</code> воспроизведение полностью останавливается.
     * Дальней воспроизведение после установки флага в состояние <code>true</code> невозможно.</p>
     */
    private boolean isStopped = false;
    /**
     * <p>Стек, в котором хранятся элементы, созданные на каждом шаге воспроизведения анимации.
     * Эти элементы - сферы, которые формируют траектории движения частиц.
     * В общем случае на определенном шаге воспроизведения будет создано столько таких сфер,
     ...
     * @param timeStep     параметр для инициализации {@link RunAnimate#timeStep}
     * @param scale        параметр для инициализации {@link RunAnimate#scale}
     * @see Trajectory3D
     * @see Group
     */
    ...
    /**
     * <p>Метод создания сферы, символизирующей частицу модели
     * или след, оставленный этой частицей.</p>
     *
